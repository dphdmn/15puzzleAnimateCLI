...
2. Compile the tool by running `compile.bat` from `colortest.cpp` and put the result in `scripts` folder, or simply download `core.exe` if you prefer the precompiled version.
